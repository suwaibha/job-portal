...
const JobListing = () => {
    ...
    useEffect(()=>{
        ...
        const matchesSearchLocation= job =>searchFilter.title ===""|| job.location.toLowerCase().includes(searchFilter.location.toLowerCase())
    ...
    return (
        <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
            ...
            <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
                ...
                <p className='mb-8'>Get your desired jobs from companies</p>
                ...
                {filteredJobs.length > 0 && (
                    <div className='flex item-center justify-center space-x-2 mt-9'>
                        <a href="#job-list">
