...
const ApplyJob = () => {
  ...
  const [jobData, setJobData] = useState(null)                   //State variable to store job data
    ...
    <>
      ...
      <div className='min-h-screen flex flex-col  py-10 container px-4 2xl:px-20 mx-auto'>
        <div className='bg-white text-black rounded-lg w-full'>
          <div className='flex justify-center md:justify-between flrx-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
